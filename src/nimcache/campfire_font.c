...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.17.0/nim/lib -o /Users/pakchoi/Workspace/campfire/src/nimcache/campfire_font.o /Users/pakchoi/Workspace/campfire/src/nimcache/campfire_font.c */
...
extern TY_9br0blXFlJAjbk9cGDwi8EgA Dl_319058_;
extern TY_OlsILfsIzW9b2h6RP9cRx1pQ Dl_319168_;
...
{	result = (FontcolonObjectType__X2ffYU2WngxpLAobRvvlFg*)0;
	...
	surface = Dl_319058_(((void*) (pixels)), w, h, ((int) 32), (NI32)(TM_sApgjWmgjI8GxczXDtC9aHg_4), ((NU32) IL64(4278190080)), ((NU32) 16711680), ((NU32) 65280), ((NU32) 255));
	nimln_(21, "font.nim");
	(*font).surface = Dl_319168_(surface, (*canvas).format, ((int) 0));
	nimln_(22, "font.nim");
	{
		NCSTRING T9_;
		NimStringDesc* T10_;
